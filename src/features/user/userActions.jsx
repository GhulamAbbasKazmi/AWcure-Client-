...
export const getUserDetails = createAsyncThunk(
  ...
  async (arg, { getState, rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.get(`${host}/api/users/profile`, config);
      return data;
    } catch (error) {
      if (error.response && error.response.data.message) {
        return rejectWithValue(error.response.data.message);
...
export const updateUserDetails = createAsyncThunk(
  ...
  async (
    { username, email, mobile, address, image, previous_image_id, imageUrl },
    { rejectWithValue }
  ) => {
    try {
      const config = {
...
export const removeUser = createAsyncThunk(
  ...
  async (arg, { getState, rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.delete(`${host}/api/users/remove`, config);
      return data;
    } catch (error) {
      if (error.response && error.response.data.message) {
        return rejectWithValue(error.response.data.message);
...
export const resetPassword = createAsyncThunk(
  ...
  async ({ password, userId, token }, { rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.post(
        `${host}/api/password-reset/${userId}/${token}`,
        {
          password,
        },
        config
...
export const verifyEmailLink = createAsyncThunk(
  ...
  async (arg, { getState, rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.get(`${host}/api/users/verify-link`, config);
      return data;
    } catch (error) {
      if (error.response && error.response.data.message) {
        return rejectWithValue(error.response.data.message);
  ...
  async ({ userId, token }, { rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.get(
        `${host}/api/users/verify-email/${userId}/${token}`,
        config
      );
      return data;
    } catch (error) {
